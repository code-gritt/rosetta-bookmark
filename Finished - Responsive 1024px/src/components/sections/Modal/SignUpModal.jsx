...
export default function SignUpModal() {
  ...
  return (
    <section className="grid max-w-3xl grid-cols-2">
      <div className="bg-primary-1300 flex flex-col justify-center gap-y-4 p-10 text-center">
      ...
      <div className="bg-primary-1500 flex flex-col justify-between gap-y-24 p-10">
        <button
