...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-bottom">
      <div className="m-auto flex max-w-[90rem] justify-between px-24 py-32 max-xl:px-16 max-xl:py-24 max-lg:grid max-lg:grid-rows-[repeat(2,auto)] max-lg:gap-y-18 max-lg:px-8">
        <div>
        ...
        <div className="grid grid-cols-[repeat(4_,max-content)] gap-x-24 max-xl:gap-x-18 max-lg:gap-x-24">
          {footerCols.map((col) => (
            <div key={col.id}>
