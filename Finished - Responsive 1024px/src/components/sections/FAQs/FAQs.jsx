...
export default function FAQ() {
  ...
  return (
    <section className="bg-gradient-to-bottom justify-items-center">
      <div className="w-full max-w-[90rem] pt-36 pb-32 max-xl:px-16 max-xl:pt-28 max-xl:pb-24 max-lg:px-8 max-lg:pt-24">
        ...
        <div className="mb-20 text-xl/loose font-light max-xl:mb-16 max-lg:mb-10 max-lg:text-lg/8">
        ...
        <ul className="mb-16 flex flex-wrap justify-center gap-x-4 gap-y-4 max-lg:mb-18">
          {FAQs.map((obj) => (
            <button
